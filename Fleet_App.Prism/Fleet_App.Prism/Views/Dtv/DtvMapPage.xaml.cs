...
{
    public partial class DtvMapPage : ContentPage
    {
        private readonly IGeolocatorService _geolocatorService;
        public DtvMapPage(IGeolocatorService geolocatorService)
        {
            InitializeComponent();
        ...
        private async void ShowPinsAsync()
        {
            ...
            double latitude = Convert.ToDouble(dtvPageViewModel.Dtv.GRXX);
            double longitude = Convert.ToDouble(dtvPageViewModel.Dtv.GRYY);
            
            var position = new Position(latitude, longitude);
            MyMap.Pins.Add(new Pin
            {
                Address = dtvPageViewModel.Dtv.DOMICILIO,
                Label = $"{dtvPageViewModel.Dtv.CLIENTE}-{dtvPageViewModel.Dtv.NOMBRE}",
                Position = position,
                Type = PinType.Place
            });
