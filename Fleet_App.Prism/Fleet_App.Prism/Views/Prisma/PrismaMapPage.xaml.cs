...
{
    public partial class PrismaMapPage : ContentPage
    {
        private readonly IGeolocatorService _geolocatorService;
        public PrismaMapPage(IGeolocatorService geolocatorService)
        {
            InitializeComponent();
        ...
        private async void ShowPinsAsync()
        {
            ...
            double latitude = Convert.ToDouble(prismaPageViewModel.Prisma.GRXX);
            double longitude = Convert.ToDouble(prismaPageViewModel.Prisma.GRYY);
            
            var position = new Position(latitude, longitude);
            MyMap.Pins.Add(new Pin
            {
                Address = prismaPageViewModel.Prisma.DOMICILIO,
                Label = $"{prismaPageViewModel.Prisma.CLIENTE}-{prismaPageViewModel.Prisma.NOMBRE}",
                Position = position,
                Type = PinType.Place
            });
