...
{
    public class TlcsPageViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<TlcItemViewModel> _cables;
        private static TlcsPageViewModel _instance;
        ...
        public ObservableCollection<TlcItemViewModel> Cables
        {
            get => _cables;
            set => SetProperty(ref _cables, value);
        }

        public List<ReclamoCable> MyTlcs { get; set; }

        public static TlcsPageViewModel GetInstance()
        {
            return _instance;
        }


        public TlcsPageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
            _apiService = apiService;
            _navigationService = navigationService;
            LoadUser();
            Cables = new ObservableCollection<TlcItemViewModel>();
            Title = "Recuperos de Telecentro";
            _instance = this;
        }
        ...
        public async void LoadUser()
        {
            ...
            var controller = string.Format("/AsignacionesTlc/GetTlcs/{0}", _user.IDUser);
            ...
            MyTlcs = (List<ReclamoCable>)response.Result;
            RefreshList();
            IsRefreshing = false;
        ...
        public void RefreshList()
        {
            ...
            if (string.IsNullOrEmpty(this.Filter))
            {
                ...
                var myListCableItemViewModel = MyTlcs.Select(a => new TlcItemViewModel(_navigationService)
                {
                    CantRem = a.CantRem,
                ...
                Cables = new ObservableCollection<TlcItemViewModel>(myListCableItemViewModel
                    .OrderBy(o => o.FechaCita + o.NOMBRE + o.FechaAsignada)
                    .Where(x => !CodigosTlc.OcultarCodigo(x.CodigoCierre, x.ESTADOGAOS)));
        ...
        {
            return CodigosTlc.GetCodigoDescription(CR);
        }
