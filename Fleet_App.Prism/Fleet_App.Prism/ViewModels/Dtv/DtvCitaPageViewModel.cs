...
{
    public class DtvCitaPageViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<DtvItemViewModel> _controlDtvs;
        ...
        public ObservableCollection<DtvItemViewModel> ControlDtvs
        {
            get => _controlDtvs;
        ...
        public DtvCitaPageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private static DtvCitaPageViewModel instance;
        public static DtvCitaPageViewModel GetInstance()
        {
            return instance;
        }
        #endregion
        ...
        private async void Save()
        {
            ...
            Dtv.FechaCita = FechaDeCita.Add(HoraDeCita);
            Dtv.MedioCita = MedioDeCita;
            ...
            var oldDtv = dtvsViewModel.MyDtvs.FirstOrDefault(o => o.ReclamoTecnicoID == this.Dtv.ReclamoTecnicoID);
        ...
        private async void LoadControlsDtv()
        {
            ...
            var controller = string.Format("/Controls/GetAutonumericos", Dtv.RECUPIDJOBCARD, Dtv.UserID);
