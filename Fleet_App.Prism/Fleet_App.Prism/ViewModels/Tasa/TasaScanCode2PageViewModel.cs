...
{
    public class TasaScanCode2PageViewModel : ViewModelBase
    {
        ...
        public TasaScanCode2PageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private async void Save()
        {
            ...
            TasaOtroRecuperoPageViewModel tasaOtroRecuperoPageViewModel = TasaOtroRecuperoPageViewModel.GetInstance();


            tasaOtroRecuperoPageViewModel.NROSERIEEXTRA = Result;
