...
{
    public class TasaOtroRecuperoPageViewModel : ViewModelBase
    {
        ...
        public TasaOtroRecuperoPageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private static TasaOtroRecuperoPageViewModel instance;
        public static TasaOtroRecuperoPageViewModel GetInstance()
        {
            return instance;
        }
        #endregion
        ...
        private async void Save()
        {
            ...
            Cliente = TasaPageViewModel.GetInstance().Tasa.CLIENTE;
        ...
        private async void SelectModem()
        {
            ...
            await _navigationService.NavigateAsync("TasaScanCode2Page");
        }
    }
}
