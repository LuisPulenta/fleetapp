...
namespace Fleet_App.Prism.ViewModels
{
    public class RemotePageViewModel : ViewModelBase
    {
        ...
        public RemotePageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private static RemotePageViewModel instance;
        public static RemotePageViewModel GetInstance()
        {
            return instance;
        }
        #endregion
        ...
        private void LoadCodigosCierre()
        {
            ...
            {
                CodigosCierre.Add(new CodigoCierre { Codigo = cr, Descripcion = CodigosRemotes.GetCodigoDescription(cr), });
            }
        }
        ...
        private async void Save()
        {
            ...
            if (Remote.ESTADOGAOS != "PAR")
            {
                ...
                
                {
                    ...
                    DescCR = CodigosRemotes.GetCodigoDescription(CR);
                ...
                if (oldRemote != null && newRemote.ESTADOGAOS == "EJB")
                {
                    ...
                    await App.Current.MainPage.DisplayAlert("Ok", "Guardado con éxito EJB!!", "Aceptar");
                    await _navigationService.GoBackAsync();
                    return;
                }
            ...
            else
            {
                ...
                if (oldRemote != null && CodigosRemotes.OcultarCodigo(newRemote.CodigoCierre, newRemote.ESTADOGAOS))
                {
                    remotesViewModel.MyRemotes.Remove(oldRemote);
                    remotesViewModel.RefreshList();
                    await App.Current.MainPage.DisplayAlert("Ok", "Guardado con éxito!!", "Aceptar");
        ...
        {
            await _navigationService.NavigateAsync("DNIPicturePage");
        }
        private async void TakeFirma()
        {
            await _navigationService.NavigateAsync("FirmaPage");
        }
