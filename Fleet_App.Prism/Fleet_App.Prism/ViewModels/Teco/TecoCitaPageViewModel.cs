...
{
    public class TecoCitaPageViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<TecoItemViewModel> _controlRemotes;
        ...
        public ObservableCollection<TecoItemViewModel> ControlRemotes
        {
            get => _controlRemotes;
        ...
        public TecoCitaPageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private static TecoCitaPageViewModel instance;
        public static TecoCitaPageViewModel GetInstance()
        {
            return instance;
        }
        #endregion
        ...
        private async void Save()
        {
            ...
            var oldRemote = tecosPageViewModel.MyRemotes.FirstOrDefault(o => o.ReclamoTecnicoID == this.Remote.ReclamoTecnicoID);


            tecosPageViewModel.MyRemotes.Remove(oldRemote);
            tecosPageViewModel.MyRemotes.Add(newRemote);

            tecosPageViewModel.LoadUser();
