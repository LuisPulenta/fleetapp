...
{
    public class TecoDniPicturePageViewModel : ViewModelBase
    {
        ...
        public TecoDniPicturePageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private async void TakeDNI()
        {
            ...
            if (_file != null)
            {
                ...
                tecoPageViewModel.ImageSource = ImageSource.FromStream(() =>
                {
                    var stream = _file.GetStream();
                    return stream;
                });
                tecoPageViewModel.File = _file;
            }
            IsRunning = false;
        }
