...
{
    public class TecoOtherPicturePageViewModel : ViewModelBase
    {
        ...
        public TecoOtherPicturePageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private async void TakeDNI()
        {
            ...
            if (_file != null)
            {
                ...
                tecoPageViewModel.ImageSource2 = ImageSource.FromStream(() =>
                {
                    var stream = _file.GetStream();
                    return stream;
                });
                tecoPageViewModel.HayFirma = true;
                tecoPageViewModel.ImageArrayFirma = FilesHelper.ReadFully(_file.GetStream());
            }
            IsRunning = false;
        }
        ...
        private async void Save()
        {
            ...
            {
                var tecoPageViewModel = TecoPageViewModel.GetInstance();
                tecoPageViewModel.ImageSource = "nophoto";
            }
            await _navigationService.GoBackAsync();
        }
    }
