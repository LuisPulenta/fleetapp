...
namespace Fleet_App.Web.Controllers.API
{
    ...
    [ApiController]
    public class AsignacionesDtvController : ControllerBase
    {
        private readonly DataContext _dataContext;

        public AsignacionesDtvController(DataContext dataContext)
        {
        ...
        public async Task<IActionResult> GetDtvs(int UserID)
        {
           ...
           .Select(g => new
           {
            ...
            if (orders == null)
            {
                return BadRequest("No hay Recuperos de Dtv para este Usuario.");
            }
